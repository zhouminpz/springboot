 ...
 * @Description:
 * @Author: zhoumin
 * @Date: created in 2018-02-08 16:39
 **/
public class PushUtil {
    private static final Gson GSON = new Gson();
    private JPushClient jpush = null;
//    masterKey=94d44f062576daa61333ae54
//    appKey= b027a99f27a7c1a6c8c8aed8
//    isProd=false

    public  PushUtil(String masterKey, String appKey, boolean isProd) {//构造器
...
//        System.out.println("----------buildPushObject_android_registrationId_alertWithTitle");
    ...
    public int pushData(String title,String altMsg,String content, Map<String,String> extraData){
        try {
            jpush.sendPush(buildPushObject_ios_all_alertWithTitle(altMsg,title,content,GSON.toJson(extraData)));
            jpush.sendPush(buildPushObject_android_all_alertWithTitle(altMsg,title,content,GSON.toJson(extraData)));
            return 1;
